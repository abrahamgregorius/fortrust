...
document.addEventListener("DOMContentLoaded", function () {
            ...
            if (!link.closest(".nav-item--dropdown")) {
                link.addEventListener("click", () => {
                    ...
                    if (elements.hamburgerBtn) {
                        const menuIcon =
                            elements.hamburgerBtn.querySelector("i");
                        if (menuIcon) {
    ...
    function initTestimonials() {
        ...
        const testimonials = [
            ...
            {
                quote: "Terima kasih banyak untuk service Fortrust especially Pak Gani yang telah membantu saya mengurus kuliah anak saya, Ardio Taulany di London, dari mulai keberangkatan, visa, kampus, kemudian kerjasama dengan uni disana, banyak sekali yang bisa didapatkan dari jasa service Fortrust, terima kasih semoga calon mahasiswa-mahasiswa lain bisa dibantu juga oleh jasa nya Fortrust",
                author: "Andre Taulany",
                role: "London",
                img: "./public/people/Andre-Taulany.jpg",
            },
            {
                quote: "Selama berkomunikasi dengan mba dela melinda, saya sangat di bantu dengan enrollment di banyak kampus. Mba dela juga membantu saya menghilangkan banyak keraguan dan ketakutan saya. So far saya merasa terbantu dengan adanya fortrust",
                author: "Maulidi Abidin Hamsyah",
                role: "Taylor's University - Bachelor of International Business and Marketing",
                img: "./public/people/Maulidi-Abidin-Hamsyah.jpg",
            },
            {
                quote: "At first i was sceptical about the agency, but after a bit of research and expireancing their services first hand. I've had a great time, the fortrust agency made everything easy and organized as a result i didn't get overwhelmed by the various administration challenges.",
                author: "Nathanael Kurniawan",
                role: "Beijing Institute of Technology - Bachelor of International Economics and Trade",
                img: "./public/people/Nathanael-Kurniawan.jpg",
            },
            {
                quote: "Mr. Febyo from Fortrust has always been a great help in getting through the important steps and procedures needed. Overall, Mr. Febyo from Fortrust is a highly recommended agent as he offers a great service and help",
                author: "Arka Arganta Pandyanatha",
                role: "Swinburne University of Technology - Bachelor of Computer Science (Cyber Security)",
                img: "./public/people/Arka-Arganta-Pandyanatha.jpg",
            },
            {
                quote: "Seneng banget karena pelayanan yang diberikan oleh fortrust 10/10. Big thanks to Bu Adel ❤️",
                author: "Kristina Stephanie Wirawan",
                role: "Langara College - Bachelor of Supply Chain and Logistic",
                img: "./public/people/Kristina-Stephanie-Wirawan.jpg",
            },
            {
        ...
        function show(index) {
            const slides =
                elements.testimonialSliderWrapper.querySelectorAll(
                    ".testimonial-card"
                );
